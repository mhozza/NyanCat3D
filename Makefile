...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?t feb 2 17:15:04 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/NyanCat3D1.0.0/ && $(COPY_FILE) --parents game.h gameobject.h room.h gameroom.h menuroom.h nyancat.h asteroid.h renderer.h model.h bitmapmodel.h utils.h mouse.h keyboard.h button.h startbutton.h quitbutton.h nyancatmodel.h universe.h universemodel.h asteroidmodel.h scoremodel.h score.h rainbow.h gameoverroom.h gameover.h scorebonus.h scorebonusmodel.h .tmp/NyanCat3D1.0.0/ && $(COPY_FILE) --parents main.cpp game.cpp gameobject.cpp room.cpp gameroom.cpp menuroom.cpp nyancat.cpp asteroid.cpp renderer.cpp model.cpp bitmapmodel.cpp utils.cpp mouse.cpp keyboard.cpp button.cpp startbutton.cpp quitbutton.cpp nyancatmodel.cpp universe.cpp universemodel.cpp asteroidmodel.cpp scoremodel.cpp score.cpp rainbow.cpp gameoverroom.cpp gameover.cpp scorebonus.cpp scorebonusmodel.cpp .tmp/NyanCat3D1.0.0/ && (cd `dirname .tmp/NyanCat3D1.0.0` && $(TAR) NyanCat3D1.0.0.tar NyanCat3D1.0.0 && $(COMPRESS) NyanCat3D1.0.0.tar) && $(MOVE) `dirname .tmp/NyanCat3D1.0.0`/NyanCat3D1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/NyanCat3D1.0.0
