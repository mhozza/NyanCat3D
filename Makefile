...
# Generated by qmake (2.01a) (Qt 4.7.4) on: st jan 18 13:46:13 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/NyanCat3D1.0.0/ && $(COPY_FILE) --parents game.h gameobject.h room.h gameroom.h menuroom.h nyancat.h camera.h asteroid.h renderer.h model.h controller.h settings.h bitmapmodel.h utils.h mouse.h keyboard.h .tmp/NyanCat3D1.0.0/ && $(COPY_FILE) --parents main.cpp game.cpp gameobject.cpp room.cpp gameroom.cpp menuroom.cpp nyancat.cpp camera.cpp asteroid.cpp renderer.cpp model.cpp controller.cpp settings.cpp bitmapmodel.cpp utils.cpp mouse.cpp keyboard.cpp .tmp/NyanCat3D1.0.0/ && (cd `dirname .tmp/NyanCat3D1.0.0` && $(TAR) NyanCat3D1.0.0.tar NyanCat3D1.0.0 && $(COMPRESS) NyanCat3D1.0.0.tar) && $(MOVE) `dirname .tmp/NyanCat3D1.0.0`/NyanCat3D1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/NyanCat3D1.0.0
