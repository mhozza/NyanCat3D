...
# Generated by qmake (2.01a) (Qt 4.7.4) on: po feb 6 14:44:25 2012
...
shaderloader.o: shaderloader.cpp shaderloader.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o shaderloader.o shaderloader.cpp
